...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private static final int START_VOID = 0x4;
    private static final int VISIBILITY = 0x5;
    private static final int DISPLAY_IMG = 0x6;
    ...
    Handler imgHandler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case DISPLAY_IMG:
                    mShakeImage.setVisibility(View.INVISIBLE);
                    break;
            }
        }
    };
    ...
    private void initView() {
        ...
        mShakeImage = (ImageView) findViewById(R.id.shake_img);
        //默认
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (type == Sensor.TYPE_ACCELEROMETER) {
            ...
            if ((Math.abs(x) > 17 || Math.abs(y) > 17 || Math
                ...
                //实现延迟小时
                final Thread imgThread = new Thread(){
                    @Override
                    public void run() {
                        super.run();
                        try {
                            Thread.sleep(1600);
                            imgHandler.obtainMessage(DISPLAY_IMG).sendToTarget();
                ...
                Thread thread = new Thread() {
                    ...
                    public void run() {
                        super.run();
                        try {
                            Log.e(TAG, "onSensorChanged: 摇动");
                            //开始震动 发出提示音 展示动画效果
                            mHandler.obtainMessage(VISIBILITY).sendToTarget();
                            Thread.sleep(500);
                            ...
                            Thread.sleep(500);
                            mHandler.obtainMessage(START_VOID).sendToTarget();
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case END_SHAKE:
                    ...
                    break;
                case START_VOID:
                    Toast.makeText(MainActivity.this,"摇一摇操作接口",Toast.LENGTH_SHORT).show();
                    break;
                case VISIBILITY:
                    mShakeImage.setVisibility(View.VISIBLE);
                    break;
            }
        }
    }
